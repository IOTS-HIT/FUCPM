 ...
 * Pruning strategy: Recurrent SWU + IEU.
...
public class AlgoFUCPM {
    ...
    public void runAlgorithm(String input, String output, double utilityratio) throws IOException {
        ...
        writer.write("=============  FUCPM ALGORITHM v1.0 - STATS ==========\n");
        ...
        writer.write(" Number of distinct items ~ " + mapItemSWU.size() + " \n");
    ...
    /**
     * Construct InstanceChain of candidate
    ...
    private void FUCPM(int[] prefix, int prefixLength, List<SeqInfoList> database, ArrayList<InstanceList> instanceChain, int itemCount) throws IOException {
        ...
        Map<Integer,Integer> mapsItemIEU = new TreeMap<>();
     ...
     * @param prefix the prefix to be written o the output file
    ...
    public void printStatistics() {
        System.out.println("=============  FUCPM ALGORITHM v1.0 - STATS  ==========");
        ...
        System.out.println(" Number of HUCSPs~ " + patternCount);
        System.out.println("========================================================");
    }
}
